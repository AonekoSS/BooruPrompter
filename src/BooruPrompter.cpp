...
void BooruPrompter::OnCreate(HWND hwnd) {
	...
	TBBUTTON tbButtons[] = {
		...
		{STD_REPLACE, ID_SORT_TAGS_AZ, TBSTATE_ENABLED, BTNS_BUTTON, {0}, 0, (INT_PTR)L"タグ整理（A-Z）"},
		{STD_REPLACE, ID_SORT_TAGS_FAV, TBSTATE_ENABLED, BTNS_BUTTON, {0}, 0, (INT_PTR)L"タグ整理（Fav）"},
	};
